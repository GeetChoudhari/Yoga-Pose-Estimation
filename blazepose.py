...
32. Right foot index '''
        ...
        st.markdown(
            "<h2 style='text-align: center; color:Red ;'>Model: </h2>", unsafe_allow_html=True)
        ...
        st.markdown(
            "<h3 style= color:Red ;'>Press the Below Button to Try out: </h3>", unsafe_allow_html=True)
    ...
    #             return model
    # model = load_model()
    st.write("To run Smoothly type Command in cmd: pip install opencv-python")
    ...
    with pre:
        st.sidebar.markdown(
            "<h1 style='color:Red ;'>References</h1>", unsafe_allow_html=True)
        st.sidebar.markdown(
        ...
        st.sidebar.markdown(
            "<h2 style='color:Red ;'>If you like the Content Press Button and Enjoy: </h2>", unsafe_allow_html=True)
        if st.sidebar.button("Press if You Like"):
            st.spinner(text="Thankyou...")
